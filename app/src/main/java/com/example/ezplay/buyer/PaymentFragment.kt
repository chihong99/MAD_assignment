...
class PaymentFragment : Fragment() {
    ...
    lateinit var minusAdult: TextView
    lateinit var plusAdult: TextView
    lateinit var qtyAdult: TextView
    lateinit var totalAdult: TextView
    lateinit var minusChild: TextView
    lateinit var plusChild: TextView
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        minusAdult = binding.minusAdultTicketQuantityTextView
        plusAdult = binding.plusAdultTicketQuantityTextView
        qtyAdult = binding.adultTicketQuantityTextView
        totalAdult = binding.adultTicketPriceTextView
        minusChild = binding.minusChildTicketQuantityTextView
        plusChild = binding.plusChildTicketQuantityTextView
